<?php
/**
 * Title: Newsletter sign-up for AI
 * Slug: twentytwentyfive/cta-newsletter-ai
...
<aside class="wp-block-group alignfull is-style-section-3" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--50)">
	...
	<div class="wp-block-group" style="min-height:360px;margin-top:0;margin-bottom:0">
		...
		<h2 class="wp-block-heading has-text-align-center has-xx-large-font-size"><?php esc_html_e( 'Fique por dentro das novidades de IA', 'twentytwentyfive' ); ?></h2>
		<!-- /wp:heading -->

		<!-- wp:paragraph {"align":"center","className":"is-style-text-subtitle"} -->
		<p class="has-text-align-center is-style-text-subtitle"><?php esc_html_e( 'Inscreva-se para receber insights, notícias e tendências sobre Inteligência Artificial diretamente no seu e-mail.', 'twentytwentyfive' ); ?></p>
		<!-- /wp:paragraph -->
		...
		<div class="wp-block-buttons"><!-- wp:button {"textAlign":"center"} -->
			<div class="wp-block-button"><a class="wp-block-button__link has-text-align-center wp-element-button"><?php esc_html_e( 'Inscrever-se', 'twentytwentyfive' ); ?></a></div>
		<!-- /wp:button --></div>
		<!-- /wp:buttons -->
	</div>
	<!-- /wp:group -->
