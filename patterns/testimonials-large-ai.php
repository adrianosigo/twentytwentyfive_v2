<?php
/**
 * Title: Review with large image on right for AI
 * Slug: twentytwentyfive/testimonials-large-ai
 * Keywords: testimonial
 * Categories: testimonials
 * Description: A testimonial with a large image on the right for an AI company.
 *
 * @package WordPress
	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group" style="min-height:100%">
				...
				<h2 class="wp-block-heading is-style-text-annotation has-x-small-font-size"><?php echo esc_html_x( 'O que nossos clientes dizem', 'Testimonial heading.', 'twentytwentyfive' ); ?></h2>
				<!-- /wp:heading -->
				...
				<blockquote class="wp-block-quote is-style-plain has-x-large-font-size" style="font-style:normal;font-weight:400">
					...
					<div class="wp-block-group" style="margin-top:0;margin-bottom:0;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
						...
						<p class="has-xx-large-font-size"><?php echo esc_html_x( '“A implementação da IA transformou nossa análise de dados. Essencial!”', 'Sample testimonial.', 'twentytwentyfive' ); ?></p>
						<!-- /wp:paragraph -->
					</div>
					<!-- /wp:group -->
					<cite><?php echo wp_kses_post( _x( 'João Silva <br /><sub>CEO, Empresa Exemplo</sub>', 'Sample testimonial citation.', 'twentytwentyfive' ) ); ?></cite>
				</blockquote>
				<!-- /wp:quote -->
			</div>
			<!-- /wp:group -->
		...
		<div class="wp-block-column" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
			...
			<figure class="wp-block-image size-large"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/man-in-hat.webp" alt="<?php echo esc_attr_x( 'Picture of a person typing on a typewriter.', 'Alt text for testimonial image.', 'twentytwentyfive' ); ?>" style="aspect-ratio:1;object-fit:cover"/></figure>
			<!-- /wp:image -->
		</div>
		<!-- /wp:column -->
	</div>
